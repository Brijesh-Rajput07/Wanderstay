        ...
        return (
            <div className='absolute inset-0 bg-black text-white min-h-screen'>
                <div className='bg-black p-8 grid gap-4'>
                    <div>
                        <h2 className='text-sm md:text-3xl font-serif mr-48'>Photos of {place.title}</h2>
                        <button onClick={() => setShowAllPhotos(false)} className='bg-white text-black fixed flex gap-1 py-2 px-4 rounded-2xl right-12 top-8 shadow shadow-black'>
